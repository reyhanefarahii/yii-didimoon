...
/**
 * Class m231119_112421_tbl_playlist
 */
class m231119_112421_tbl_playlist extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->addForeignKey('channel_id', '{{%tbl_channel}}', 'user_id', '{{%user}}', 'id',
        'CASCADE', 'CASCADE');
        // $this->addForeignKey(
        //     '{{%user}}',
        //     '{{%tbl_playlist}}',
    ...
    {
        echo "m231119_112421_tbl_playlist cannot be reverted.\n";
